...
PRODUCT_COPY_FILES += \
    vendor/kasumi/config/permissions/lineage-sysconfig.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/lineage-sysconfig.xml

# Lineage-specific init rc file
PRODUCT_COPY_FILES += \
    vendor/kasumi/prebuilt/common/etc/init/init.lineage-system_ext.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.lineage-system_ext.rc

# Enable Android Beam on all targets
PRODUCT_COPY_FILES += \
    vendor/kasumi/config/permissions/android.software.nfc.beam.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/android.software.nfc.beam.xml
...
# This is Kasumi!
PRODUCT_COPY_FILES += \
    vendor/kasumi/config/permissions/org.lineageos.android.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/org.lineageos.android.xml
...
$(call enforce-product-packages-exist-internal,$(wildcard device/*/$(KASUMI_BUILD)/$(TARGET_PRODUCT).mk),product_manifest.xml rild Calendar Launcher3 Launcher3Go Launcher3QuickStep Launcher3QuickStepGo android.hidl.memory@1.0-impl.vendor vndk_apex_snapshot_package)
endif
...
PRODUCT_COPY_FILES += \
    vendor/kasumi/prebuilt/common/etc/init/init.lineage-updater.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.lineage-updater.rc

# Config
PRODUCT_PACKAGES += \
    SimpleDeviceConfig

# Extra tools in Kasumi
PRODUCT_PACKAGES += \
    bash \
    curl \
    getcap \
...
PRODUCT_COPY_FILES += \
    vendor/kasumi/prebuilt/common/etc/init/init.openssh.rc:$(TARGET_COPY_OUT_PRODUCT)/etc/init/init.openssh.rc
...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/kasumi/overlay/no-rro
PRODUCT_PACKAGE_OVERLAYS += \
    vendor/kasumi/overlay/common \
    vendor/kasumi/overlay/no-rro
