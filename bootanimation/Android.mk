...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP) $(shell find vendor/kasumi/bootanimation/ -type f)
	@echo "Building bootanimation.zip"
	@rm -rf $(dir $@) $(INTERMEDIATES)
	@mkdir -p $(dir $@) $(INTERMEDIATES)
	$(hide) cp -R vendor/kasumi/bootanimation/frames/. $(INTERMEDIATES)
	...
	echo "$$SCALE_WIDTH $$SCALE_HEIGHT $$(cat vendor/kasumi/bootanimation/fps.txt)" > $(INTERMEDIATES)/desc.txt; \
