...
# Copyright (C) 2022 Project Kasumi
#
...
bandori: $(INTERNAL_OTA_PACKAGE_TARGET) otatools target-files-package
	...
	@echo "Based on LineageOS, brought to you by Yuki (@yukiqt) and Beru Hinode (@StellSstructure)." >&2
endif
else
# Builds that can't be signed must have signature enforcement disabled using the flag above.
# And builds that aren't marked as official aren't required to be signed.
