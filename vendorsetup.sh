...
export ROM_VERSION="$( (xmlstarlet sel -t -v "/manifest/remote[@name='kasumi']/@revision" "$TOP/.repo/manifests/snippets/kasumi.xml" | sed -e 's/refs\/heads\///') || \
